...
Version  : 1.0.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/pkgbuild_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgbuild_1.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532898381
